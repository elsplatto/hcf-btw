...
if (isset($locationId))
{
    ...
    $query .= 'categories.title AS category_title, types.title AS type_title FROM tiles ';
    ...
    $numRows = count($stmt->bind_result($title, $image_med, $alt, $sub_heading, $intro_text, $lat, $lng, $trip_plan, $address_text, $category_title, $type_title));
