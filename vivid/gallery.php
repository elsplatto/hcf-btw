...
<section class="photoSection<?=$galleryHeaderClass?>">
    ...
    $callbackURL = $baseURL.'/vivid/gallery';
                        ...
                        <div class="large-12 medium-12 small-12 insta sharedPhoto">
                            ...
                            <div class="infoContainer">
                                <div class="inner">
                                    ...
                                    <a href="https://twitter.com/share?url=<?=$baseURL?>/gallery/<?=$sharedPhoto->data->id?>&text=Check out shot of the day&hashtag=vividsydney&count=none" class="twitter-share-button gallery-tweet" data-lang="en">Tweet</a>
...
<section class="photoSection marginBottomStandard">
    ...
    $instagramResults = $instagram->getTagMedia('vividsydney',$tokenSet);
                ...
                <div class="small-12 medium-12 large-12 insta">
                    ...
                    <div class="infoContainer">
                        <div class="inner">
                            ...
                            <a href="https://twitter.com/share?url=<?=$baseURL?>/gallery/<?=$post[$i]->id?>&text=Check out shot of the day&hashtag=vividsydney&count=none" class="twitter-share-button gallery-tweet" data-lang="en">Tweet</a>
                            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
                ...
                <div class="small-12 large-12 insta">
                    ...
                    <div class="infoContainer">
                        <div class="inner">
                            ...
                            ?>
                            <span class="credit"><?=$post[$i]->user->username?></span>
                            <a href="https://twitter.com/share?url=<?=$baseURL?>/gallery/<?=$post[$i]->id?>&text=Check this photo out&hashtag=vividsydney&count=none" class="twitter-share-button gallery-tweet" data-lang="en">Tweet</a>
                            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
