    ...
    function showLocations(locations)
    {
        for (var i=0; i<locations.length;i++)
        {
            (function(location){
                ...
                locationContent += '<h5><a href="#" class="panelFlyoutTrigger" data-location="'+location.id+'" data-target="mapContainer" onClick="trackInternalLink(\'Tile on <?=$pageHeading?> map - click\', \''+location.title.replace(/'/g, "\\'")+'\'); return false;">'+location.title+'</a></h5>';
                locationContent += '</div>';
